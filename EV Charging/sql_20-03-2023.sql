...
-- Create the 'login' table to store user credentials
CREATE TABLE login (
...
-- Create the 'contact_us' table to store feedback from users
...
-- Create the 'admin_charging_station_list' table to store station information
...
(7, 'GHI Charging Station', '1617 Birch St', 'Ernakulam', 'AC Level 1 Charging', 2, 'inactive'),
